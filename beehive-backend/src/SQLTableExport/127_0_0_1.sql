...
(1, 'projectbeehive', 'posts', 'post_image', '', 'image_jpeg', '', '', '', '');
...
('root', '[{\"db\":\"projectbeehive\",\"table\":\"users\"},{\"db\":\"projectbeehive\",\"table\":\"friends\"},{\"db\":\"projectbeehive\",\"table\":\"posts\"},{\"db\":\"projectbeehive\",\"table\":\"Friends\"}]');
...
('root', '2023-03-20 16:33:17', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":0}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Database: `projectbeehive`
--
CREATE DATABASE IF NOT EXISTS `projectbeehive` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `projectbeehive`;
...
CREATE TABLE `posts` (
  ...
  `user_id` bigint(255) NOT NULL,
  `poster_comment` int(11) NOT NULL,
...
CREATE TABLE `users` (
  ...
  `roles` varchar(10) CHARACTER SET utf16 COLLATE utf16_general_ci NOT NULL,
